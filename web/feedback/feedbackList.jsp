...
<%--引入JavaBean对象--%>
<jsp:useBean id="FeedBackServices" class="service.FeedBackServices"></jsp:useBean>
...
<%
    ...
    List dbi = FeedBackServices.queryAllFeedback();
...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <div class="am-g am-u-sm-12" class="am-pre-scrollable ">
            <div class="am-g ">
                <h2 align="center">用户反馈列表：共 <%=dbi.size()%> 个反馈</h2>
                ...
                <div class="am-u-sm-12 am-scrollable-horizontal">
                    ...
                    <table class="table2excel am-table am-table-compact am-table-bd am-text-nowrap am-table-centered am-table-striped am-table-hover admin-content-table ">
                        ...
                        <%
                            //迭代器迭代输出带班信息
                            while (iter.hasNext()) {
                                Feedback db = (Feedback) iter.next();
                        %>
                        <tr>
                            <td>
                            ...
                            <td>
                                <%
                                    //                                    此处有bug
                                    if (db.getStatus() == 0) {%> <span
                                    class="am-badge am-badge-warning">未处理</span><%} else if (db.getStatus() == 1) {%> <span
                                    class="am-badge am-badge-primary">已处理</span><%} else if (db.getStatus() == 2) {%> <span
                                    class="am-badge am-badge-secondary">延时处理</span><%} else if (db.getStatus() == 3) {%> <span
                                    class="am-badge am-badge-secondary">需要上报</span><%} else if (db.getStatus() == 4) {%> <span
                                    class="am-badge am-badge-danger">无法处理</span><%
                                }
                            %>
                            </td>
                        </tr>
