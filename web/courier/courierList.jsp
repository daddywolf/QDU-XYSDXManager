...
<%--引入JavaBean对象--%>
<jsp:useBean id="CourierServices" class="service.CourierServices"></jsp:useBean>
...
<%
    ...
    List dbi = CourierServices.queryAllCourier();
...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">快递员列表</strong> /
                ...
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <button type="button" class="am-btn am-btn-default"><a href="javascript:newOrder()"><span
                                class="am-icon-plus"></span> 新增快递员</a>
                        </button>
            ...
            <div class="am-u-sm-12 am-u-md-3">
                <select data-am-selected="{btnSize: 'sm',searchBox: 1}">
                    <optgroup label="按信息类型">
                        <option value="userid">用户ID为</option>
                        <option value="mobile">手机号为</option>
                        <option value="realname">真实姓名为</option>
                    </optgroup>
                </select>
            </div>
            <div class="am-u-sm-12 am-u-md-3">
        ...
        <div class="am-g am-u-sm-12" class="am-pre-scrollable ">
            <div class="am-g ">
                <h2 align="center">快递员列表：共 <%=dbi.size()%> 个快递员</h2>
                ...
                <div class="am-u-sm-12 am-scrollable-horizontal">
                    ...
                    <table class="table2excel am-table am-table-compact am-table-bd am-text-nowrap am-table-centered am-table-striped am-table-hover admin-content-table ">
                        ...
                        <tr>
                            <td>
                                <div class="am-dropdown " data-am-dropdown>
                                    ...
                                    <ul class="am-dropdown-content">
                                        <li><a href="#">1. 修改用户信息</a></li>
                                        <li><a href="javascript:del('<%=db.getCourierid()%>')">2. 彻底删除用户</a></li>
                            ...
                            <td>
                                <%
                                    if (db.getIdCard() == null || db.getIdCard().equals("")) {
                                        out.print("<span class=\"am-badge am-badge-warning\">未填写</span>");
                                    } else {
                                        out.print(db.getIdCard());
                                    }
                                %>
                            </td>
                            <td>
                                <%
                                    if (db.getStuCard() == null || db.getStuCard().equals("")) {
                                        out.print("<span class=\"am-badge am-badge-warning\">未填写</span>");
                                    } else {
                                        out.print(db.getStuCard());
                                    }
                                %>
                            </td>
                            <td>
                            ...
                            <td>
                                <%
                                    if (db.getDormitorRm() == null || db.getDormitorRm().equals("")) {
                                        out.print("<span class=\"am-badge am-badge-warning\">未填写</span>");
                                    } else {
                                        out.print(db.getDormitorRm());
                                    }
                                %>
                            </td>
                            <td>
