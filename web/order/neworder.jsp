...
<div class="am-cf admin-main">
    <div class="am-panel am-panel-default">
        <div class="am-panel-bd">
            <p align="center"><strong>创建新订单</strong></p>
            ...
            <form class="am-form am-form-horizontal" action="saveorder.jsp" method="post" data-am-validator>

                <div class="am-form-group">
                    <label class="am-u-sm-3 am-form-label">订单号</label>
                    <div class="am-u-sm-9">
                        <input type="text" name="orderid" id="orderid" disabled placeholder="自动生成,不可手工填写">
                    </div>
                </div>
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                        <input type="text" name="others" id="others" placeholder="可不填">
                    </div>
                </div>
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                        <input type="radio" name="status" id="0" value="0">未分配&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" name="status" id="1" value="1">分配中&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" name="status" id="2" value="2">派送中&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" name="status" id="3" value="3">已完成&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" name="status" id="4" value="4">已取消&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" name="status" id="5" value="5">已删除&nbsp;&nbsp;&nbsp;&nbsp;
                    </div>
                </div>
