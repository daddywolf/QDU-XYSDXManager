...
<%--引入JavaBean对象--%>
<jsp:useBean id="UserInfoServices" class="service.UserInfoServices"></jsp:useBean>
...
<%
    ...
    List dbi = UserInfoServices.queryAllUser();
...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
                ...
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <button type="button" class="am-btn am-btn-default"><a href="javascript:newOrder()"><span
                                class="am-icon-plus"></span> 新增用户</a>
                        </button>
        ...
        <div class="am-g am-u-sm-12" class="am-pre-scrollable ">
            <div class="am-g ">
                <h2 align="center">用户列表：共 <%=dbi.size()%> 个用户</h2>
                ...
                <div class="am-u-sm-12 am-scrollable-horizontal">
                    ...
                    <table class="table2excel am-table am-table-compact am-table-bd am-text-nowrap am-table-centered am-table-striped am-table-hover admin-content-table ">
                        ...
                        <%
                            //迭代器迭代输出带班信息
                            while (iter.hasNext()) {
                                UserInfo db = (UserInfo) iter.next();
                        %>
                        <tr>
                            <td>
                                <div class="am-dropdown " data-am-dropdown>
                                    ...
                                    <ul class="am-dropdown-content">
                                        ...
                                        <li><a href="javascript:del('<%=db.getUserid()%>')">2. 彻底删除用户</a></li>
