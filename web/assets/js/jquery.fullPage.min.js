    ...
    e.fn.fullpage = function (s) {
        ...
        function Q() {
            Xn.css({
                ...
                var o = e(this), t = o.find(I), i = t.length;
        ...
        function se() {
            ...
            for (var o = 0; o < e(T).length; o++) {
                ...
                var i = '<li><a href="#' + t + '"><span></span></a>', r = s.navigationTooltips[o];
        ...
        function de() {
            ...
            if (!s.autoScrolling || s.scrollBar) {
                ...
                if (ue(i) && (e(C).hasClass(w) || e(C).addClass(w).siblings().removeClass(w)), n = e(l).eq(r), !n.hasClass(g)) {
                    io = !0;
                    var d = e(C), u = d.index(T) + 1, h = on(n), p = n.data("anchor"), v = n.index(T) + 1, m = n.find(P);
                    if (m.length)var S = m.data("anchor"), y = m.index();
        ...
        function ve(n) {
            ...
            if (!me(n.target) && ge(o)) {
                ...
                var i = e(C), r = s.scrollOverflowHandler.scrollable(i);
                if (Qn && !Wn) {
                    var a = An(o);
        ...
        function ye(o) {
            var i = (new Date).getTime(), r = e(y).hasClass(E);
            if (s.autoScrolling && !Vn && !r) {
                o = o || n.event;
                var a = o.wheelDelta || -o.deltaY || -o.detail, l = t.max(-1, t.min(1, a)), c = "undefined" != typeof o.wheelDeltaX || "undefined" != typeof o.deltaX, f = t.abs(o.wheelDeltaX) < t.abs(o.wheelDelta) || t.abs(o.deltaX) < t.abs(o.deltaY) || !c;
                Gn.length > 149 && Gn.shift(), Gn.push(t.abs(a)), s.scrollBar && (o.preventDefault ? o.preventDefault() : o.returnValue = !1);
                var d = e(C), u = s.scrollOverflowHandler.scrollable(d), h = i - fo;
                if (fo = i, h > 200 && (Gn = []), Qn) {
                    var p = we(Gn, 10), v = we(Gn, 70), m = p >= v;
        ...
        function be(n, o) {
            var t = "undefined" == typeof o ? e(C) : o, i = t.find(W), r = i.find(I).length;
            if (!(!i.length || Wn || 2 > r)) {
                var a = i.find(P), l = null;
        ...
        function Te(e, n) {
            var o = e.top, t = e.top > uo, i = o - Nn + n.outerHeight();
            ...
            requestAnimFrame(function () {
                ...
                if ("undefined" != typeof i) {
                    ...
                    if (!(a.activeSection.is(n) && !Kn || s.scrollBar && ie.scrollTop() === a.dtop && !n.hasClass(M))) {
                        if (a.activeSlide.length)var l = a.activeSlide.data("anchor"), c = a.activeSlide.index();
        ...
        function Ae(e) {
            var n = {};
            return s.autoScrolling && !s.scrollBar ? (n.options = {top: -e.dtop}, n.element = l) : (n.options = {scrollTop: e.dtop}, n.element = "html, body"), n
        }
        ...
        function ze() {
            if (!io && !s.lockAnchors) {
                var e = n.location.hash.replace("#", "").split("/"), o = e[0], t = e[1], i = "undefined" == typeof In, r = "undefined" == typeof In && "undefined" == typeof t && !Wn;
        ...
        function Xe(n) {
            n.preventDefault();
            var o = e(this).closest(T).find(W), t = o.find(I).eq(e(this).closest("li").index());
            je(o, t)
        }
        ...
        function je(n, o) {
            var i = o.position(), r = o.index(), a = n.closest(T), l = a.index(T), c = a.data("anchor"), f = a.find(K), d = mn(o), u = a.find(P), h = Kn;
            if (s.onSlideLeave) {
                var p = u.index(), v = tn(p, r);
        ...
        function $e(e, n) {
            var o = 825, i = 900;
            if (o > e || i > n) {
                var r = 100 * e / o, a = 100 * n / i, l = t.min(r, a), s = l.toFixed(2);
                On.css("font-size", s + "%")
        ...
        function rn(e) {
            ...
            var n, o = s.scrollOverflowHandler, t = o.wrapContent(), i = e.closest(T), r = o.scrollable(e);
        ...
        function fn(e, n) {
            var o = n.find(W), t = o.find(I + '[data-anchor="' + e + '"]');
        ...
        function gn() {
            var n = e(C), o = n.find(P), t = mn(n), i = mn(o), r = (n.index(T), String(t));
        ...
        var zn = e("html, body"), On = e("body"), Dn = e.fn.fullpage;
        s = e.extend({
            menu: !1,
            anchors: [],
            lockAnchors: !1,
            ...
            if (!Xn.hasClass(p)) {
                ...
                Nn = ie.height(), s.resize && $e(Nn, o), e(T).each(function () {
                    var n = e(this).find(W), o = e(this).find(I);
        ...
        var In, Pn, Vn, Wn = !1, Yn = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/), Un = "ontouchstart" in n || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, Xn = e(this), Nn = ie.height(), Kn = !1, jn = !0, Qn = !0, Gn = [], Jn = {};
        Jn.m = {up: !0, down: !0, left: !0, right: !0}, Jn.k = e.extend(!0, {}, Jn.m);
        var Zn, $n, _n, eo, no, oo, to = e.extend(!0, {}, s);
        e(this).length && (c(), f());
        var io = !1, ro = 0, ao = 0, lo = 0, so = 0, co = 0, fo = (new Date).getTime();
